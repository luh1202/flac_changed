...
do 2  i = 1,nx-1
    do 2  j = 1,nz-1 !loop over every element
        ...
        !srII = 0.5 * (s11*s22 - s12*s12)
        srII = 0.5 * sqrt(s11**2 + s22**2 + 2*(s12*s12))
        !srII = 0.5 * (s12*s12- s11*s22)
        !srI = (s11+s22)/2
        srI = s11 + s22
        ...
        stII = 0.5 * sqrt(s11**2 + s22**2 + 2*(s12*s12))
        !stII = 0.5 * (s11*s22 - s12*s12)
        !stII = 0.5 * (s12*s12- s11*s22)
